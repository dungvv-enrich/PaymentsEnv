...
window.onload = function () {
  ...
  if (amount === null || key === null) {
    console.error("Amount or Key is missing in URL parameters!")
  } else {
    console.log(`Amount: ${amount}, Key: ${key}`)
    let googlePayUrl = `https://pay.google.com/gp/p/js/pay.js?amount=${amount}&key=${key}`
    console.log("Google Pay URL:", googlePayUrl)
    ;(function (d, s, id) {
      var js,
    ...
    })(document, "script", "google-pay-clientid")
  }
}
